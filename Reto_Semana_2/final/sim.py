...
def simulate_husky(seed=None):
    ...
    boxes = create_random_husky_boxes(seed=seed)
    ...
    for t in np.arange(0, 30, dt):
        ...
        error = np.arctan2(
            np.sin(theta_target - husky.theta),
        ...
        lidar_readings, hit_boxes, ray_lines = lidar_scan(husky, boxes)
